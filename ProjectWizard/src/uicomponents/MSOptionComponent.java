...
public class MSOptionComponent extends VerticalLayout {
  ...
  logging.Logger logger = new Log4j2Logger(MSOptionComponent.class);
  ...
  public List<WizardStep> getNextMSSteps(Map<control.WizardController.Steps, WizardStep> steps) {
